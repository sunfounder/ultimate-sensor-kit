...
2. Open the ``00-Set_software_serial.ino`` file under the path of ``iot-sensor-kit\iot_project\00-Set_software_serial``. Or copy this code into Arduino IDE. And upload the code.
